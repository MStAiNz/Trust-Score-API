"""
Django settings for trust_score project.
...
SECRET_KEY = 'django-insecure-ly3*u1a_skler14gaux1ph^asia8psim$vwmj&e9hyi#tw-&tj'
...
WSGI_APPLICATION = 'trust_score.wsgi.application'
